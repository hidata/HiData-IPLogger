# گزارش فعالیت مشتریان (HiData IP Logger) برای WHMCS
...
2. در ناحیه مدیریت WHMCS از مسیر **System Settings > Addon Modules** افزونه «گزارش فعالیت مشتریان» را فعال کنید.
...
## کرون
کرون WHMCS:
- کرون روزانه: رکوردهای قدیمی‌تر از مدت نگهداری را حذف می‌کند (اگر > 0 باشد).
- کرون تکرارشونده (هر ۵ دقیقه): رکوردهای بدون کشور/ISP را با استفاده از `ip-api.com` (countryCode/isp) تکمیل می‌کند (حداکثر 20 رکورد در هر اجرا).
